...
#define TF_CSEIFE_H_VERSION "TF_CSEIFE_H   V1.2"
#define TF_CSEIFE_H_CVSID "$Id: cseife.h 3381 2010-11-15 12:33:00Z tforb $"
 ...
 */
void seife_he2(double* x, int n, double dt, double t0s, double hs, double t0,
               double h);
/* 2nd order lowpass equalizer (former: period t0s and damping hs,
 *                              new: period t0 and damping h)
 */
void seife_le2(double* x, int n, double dt, double t0s, double hs, double t0,
               double h);
...
struct seife_IIRcoef seife_rfk(enum seife_filter_type IIRtype, double t0,
                               double h, double t0s, double hs);
/* general Butterworth filter framework */
void seife_butterworth(double* x, int n, double dt,
                       enum seife_filter_type IIRtype, double t0, int o);
