 ...
 * ============================================================================
 */
#define TF_CSEIFE_C_VERSION "TF_CSEIFE_C   V1.2"
#define TF_CSEIFE_C_CVSID "$Id: cseife.c 3381 2010-11-15 12:33:00Z tforb $"
...
/* enter debug mode */
void seife_debug_mode_on() { seife_global_flags.debug = 1; }
...
void seife_butterworth(double* x, int n, double dt,
                       enum seife_filter_type IIRtype, double t0, int m) {
