...
int SEISMO, NDT, NDTSHIFT, NGEOPH, SEIS_FORMAT, FREE_SURF, READMOD, MOD_FORMAT,
    READREC, REC_ARRAY, LOG, FDORDER, FW = 0, ABS_TYPE, BLOCK;
int NX, NY, NZ = 1, NT, SOURCE_SHAPE, SOURCE_TYPE, SNAP, SNAP_FORMAT, BOUNDARY,
            SRCREC, SNAP_PLANE;
float ALPHA, BETA;
int NXG, NYG, NZG, IDX, IDY, IDZ, L = 1, NX1, NX2, NY1, NY2, NZ1, NZ2, DRX, DRZ,
                                  RUN_MULTIPLE_SHOTS, FDCOEFF;
char SNAP_FILE[STRING_SIZE], SOURCE_FILE[STRING_SIZE], SIGNAL_FILE[STRING_SIZE],
    INV_FILE[STRING_SIZE];
...
int FDMPIVERS; /* version of fdmpi 33: current 3D isotropic elastic (SSG), 32:
                  current 3D isotropic acoustic (SSG) */
...
int GRADMO;
int SAVESU;
char MOD_OUT_FILE[STRING_SIZE], HESS_FILE[STRING_SIZE], GRAD_FILE[STRING_SIZE],
